...
class QrScannerOverlayShapeCustom extends ShapeBorder {
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection textDirection}) {
    ...
    final cutOutRect = Rect.fromLTWH(
      ...
      height / 1.6 - _cutOutSize / 2 + borderOffset,
  ...
  ShapeBorder scale(double t) {
    return QrScannerOverlayShapeCustom(
